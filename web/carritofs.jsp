...
body{
 ...
 <meta charset="UTF-8" />
	...
	<body>
                ...
                <div id='txtp'>
                    <CENTER>
                          <a href="menos.jsp"><button class="btn btn-4 btn-4a">Menores Venas</button></a>
                           <a href="mayor.jsp"><button class="btn btn-4 btn-4a">Mayores Ventas</button></a>
                            <a href="Grafica.jsp"><button class="btn btn-4 btn-4a">Grefica de Ventas</button></a>
                </center>   
                   <form  >
  ...
  <% 
LinkedList<consulta> lista = busca.getconsulta();
